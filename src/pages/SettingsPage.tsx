  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Manage your account and email notifications</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200">
        <div className="px-6 py-4 border-b border-slate-200 flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-slate-900">Email Notification Settings</h2>
        </div>
        <form onSubmit={handleSmtpSave} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">Notification Email</label>
              <input
                type="email"
                value={smtp.email}
          ...
          <div className="flex items-center justify-end pt-4 border-t border-slate-200">
            <button
              ...
              className="inline-flex items-center gap-2 border border-slate-300 hover:bg-slate-50 text-slate-700 text-sm font-medium px-5 py-2.5 rounded-lg transition-colors disabled:opacity-50 mr-3"
            >
